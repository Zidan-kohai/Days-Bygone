...
namespace Randoms.DailyReward
{
    ...
    {
        [SerializeField] private GameObject takenPanel;
        [SerializeField] private GameObject cantTakePanel;
        ...
        public void Taken()
        {
            ...
            takenPanel.SetActive (true);
        }

        public void cantTaken()
        {
            cantTakePanel.SetActive(true);
